...
#define START_MASTERNODE_PAYMENTS_TESTNET 1576195200 
#define START_MASTERNODE_PAYMENTS  1576281600

static const int64_t DARKSEND_COLLATERAL = (1000000*COIN);
static const int64_t DARKSEND_FEE = (0.01*COIN);
static const int64_t DARKSEND_POOL_MAX = (99999999.99*COIN);
...
static const unsigned int MAX_BLOCK_SIZE = 128000000; // 128 Megabyte blocks
...
static const unsigned int MAX_P2SH_SIGOPS = 16;
/** The maximum number of sigops we're willing to relay/mine in a single tx */
static const unsigned int MAX_TX_SIGOPS = MAX_BLOCK_SIGOPS/5;
/** The maximum number of orphan transactions kept in memory */
static const unsigned int MAX_ORPHAN_TRANSACTIONS = MAX_BLOCK_SIZE/10; //25.6 megabyte
/** Default for -maxorphanblocks, maximum number of orphan blocks kept in memory */
static const unsigned int DEFAULT_MAX_ORPHAN_BLOCKS = 900;
...
static const int64_t COIN_YEAR_REWARD = 90 * CENT; // 90% Per Year
/** This is the block target time for PoW/PoS mining */
static const int64_t TARGET_SPACING = 90; // 90 second block times expected
...
static const int64_t DRIFT = 600; // 6 minute drift time
