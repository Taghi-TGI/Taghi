...
enum WalletFeature
{
    ...
    FEATURE_WALLETCRYPT = 50000, // wallet encryption
    FEATURE_COMPRPUBKEY = 70000, // compressed public keys
...
enum AvailableCoinsType
{
    ...
    ONLY_NONDENOMINATED_NOTMN = 4 // ONLY_NONDENOMINATED and not 1000 TGI at the same time
};
